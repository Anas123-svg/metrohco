                                ...
                                <div class="form-group">
                                    ...
                                    <select name="payment" id="payment" class="form-control">
                                        ...
                                        <option value="pending"
                                            {{ request()->input('payment') == 'pending' ? 'selected' : '' }}>
                                            {{ __('Pending') }}
                                        </option>
                                        <option value="complete"
                                            {{ request()->input('payment') == 'complete' ? 'selected' : '' }}>
                                            {{ __('Complete') }}
                                        </option>
                                        <option value="rejected"
                                            {{ request()->input('payment') == 'rejected' ? 'selected' : '' }}>
                                            {{ __('Rejected') }}
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="Status" class="form-control">
                                        ...
                                        <option value="featured"
                                            {{ request()->input('status') == 'featured' ? 'selected' : '' }}>
                                            {{ __('Featured') }}</option>
                                        <option value="rejected"
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ $request->price }}
                                                    ...
                                                    @elseif($request->payment_status == 'pending')
                                                        @if ($request->gateway_type == 'iyzico' || $request->gateway_type == 'now_payment')
                                                ...
                                                <td>
                                                    @if (!empty($request->attachment))
                                                        ...
                                                        @includeIf('admin.featured-properties.show_attachment')
                                                    @else
                                                        -
                                                    @endif
                                                </td>
