                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3 mb-4">
                            <a href="{{ route('admin.mobile_interface_content', ['language' => $defaultLang->code]) }}"
                        ...
                        <!--general settings-->
                        <div class="col-sm-6 col-md-3 mb-4">
                            <a href="{{ route('admin.mobile_interface_general_setting') }}" class="text-decoration-none">
                                <div class="d-flex align-items-center p-3 rounded border h-100 transition-hover">
                                    <div class="mx-3">
                                        <span class="d-inline-block bg-light rounded-circle p-3">
                        ...
                        <!--notification-->
                        <div class="col-sm-6 col-md-3 mb-4">
                            <a href="{{ route('admin.mobile_interface.notification') }}" class="text-decoration-none">
                                <div class="d-flex align-items-center p-3 rounded border h-100 transition-hover">
                                    <div class="mx-3">
                                        <span class="d-inline-block bg-light rounded-circle p-3">
                                    ...
                                    <div>
                                        <h5 class="mb-1 text-muted"> {{ __('Notification') }}</h5>
                                        <div class="fw-semibold text-muted"> {{ __('Create and send notifications') }}
                                        </div>
                                    </div>
                                </div>
                            </a>
