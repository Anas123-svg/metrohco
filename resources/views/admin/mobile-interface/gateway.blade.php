            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  @endif
                  <span>
                    <span class="text-warning">{{ __('Set these URLs in Midtrans Dashboard like this') . ':' }}</span>
                    <a href="https://prnt.sc/OiucUCeYJIXo" target="_blank">{{ __('See Example') }}</a>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="api_key" value="{{ @$monifyInfo['api_key'] }}">
