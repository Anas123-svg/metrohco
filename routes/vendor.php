  ...
  ->group(function () {
    ...
    Route::middleware('vendorHasPackage')->group(function () {
      Route::prefix('property-management')->group(function () {
        ...
        Route::post('update-mobile-image', 'Vendor\PropertyController@updateMobileImage')->name('vendor.property_management.feature.update_mobile_image');
        ...
        //now payment
        Route::prefix('/featured/nowpayment')->group(function () {
          Route::get('/payment/success', 'Vendor\FeaturedProperty\Payment\NowpaymentController@paymentSuccess')->name('vendor.featured.nowpayment.success');
          Route::get('/payment/cancel', 'Vendor\FeaturedProperty\Payment\NowpaymentController@paymentCancel')->name('vendor.featured.nowpayment.cancel');
        });

        Route::get('/featured/perfect_money/success', 'Vendor\FeaturedProperty\Payment\PerfectMoneyController@successPayment')->name('vendor.featured.perfect_money.success');
        Route::get('/featured/perfect_money/cancel', 'Vendor\FeaturedProperty\Payment\PerfectMoneyController@cancelPayment')->name('vendor.featured.perfect_money.cancel');


        Route::any('/featured/yoco/success', 'Vendor\FeaturedProperty\Payment\YocoController@successPayment')->name('vendor.featured.yoco.success');
        Route::get('/featured/yoco/cancel', 'Vendor\FeaturedProperty\Payment\YocoController@cancelPayment')->name('vendor.featured.yoco.cancel');




        Route::post('/featured/paytabs/success', 'Vendor\FeaturedProperty\Payment\PaytabsController@successPayment')->name('vendor.featured.paytabs.success');
        Route::get('/featuredpaytabs/cancel', 'Vendor\FeaturedProperty\Payment\PaytabsController@cancelPayment')->name('vendor.featured.paytabs.cancel');

        Route::post('/featured/paytabs/success', 'Vendor\FeaturedProperty\Payment\MyFatoorahController@successPayment')->name('vendor.featured.myfatoorah.success');
        Route::get('/featuredpaytabs/cancel', 'Vendor\FeaturedProperty\Payment\MyFatoorahController@cancelPayment')->name('vendor.featured.myfatoorah.cancel');



        Route::get('/featured/toyyibpay/success', 'Vendor\FeaturedProperty\Payment\ToyyibpayController@successPayment')->name('vendor.featured.toyyibpay.success');
        Route::get('/featured/toyyibpay/cancel', 'Vendor\FeaturedProperty\Payment\ToyyibpayController@cancelPayment')->name('vendor.featured.toyyibpay.cancel');

        Route::any('/featured/phonepe/success', 'Vendor\FeaturedProperty\Payment\PhonePeController@successPayment')->name('vendor.featured.phonepe.success');
        Route::get('/featured/phonepe/cancel', 'Vendor\FeaturedProperty\Payment\PhonePeController@cancelPayment')->name('vendor.featured.phonepe.cancel');

        Route::get('/featured/midtrans/success/{id}', 'Vendor\FeaturedProperty\Payment\MidtransController@cardNotify')->name('vendor.featured.midtrans.success');
        Route::get('/featured/midtrans/cancel', 'Vendor\FeaturedProperty\Payment\MidtransController@cancelPayment')->name('vendor.featured.midtrans.cancel');

        Route::get('/featured/xendit/success', 'Vendor\FeaturedProperty\Payment\XenditController@successPayment')->name('vendor.featured.xendit.success');
        Route::get('/featured/xendit/cancel', 'Vendor\FeaturedProperty\Payment\XenditController@cancelPayment')->name('vendor.featured.xendit.cancel');




        Route::post('/featured/iyzico/success', 'Vendor\FeaturedProperty\Payment\IyzicoController@successPayment')->name('vendor.featured.iyzico.success');
        Route::get('/featured/iyzico/cancel', 'Vendor\FeaturedProperty\Payment\IyzicoController@cancelPayment')->name('vendor.featured.iyzico.cancel');
        ...
        Route::get('/featured/cancel', 'Vendor\FeaturedProperty\PaymentController@cancel')->name('vendor.featured.cancel');
      });
