...
Route::post('/property/video-img-rmv', 'Admin\Property\PropertyController@videoImgrmv')->name('property.videoImgrmv');
Route::post('/property/floor-img-rmv', 'Admin\Property\PropertyController@floorImgrmv')->name('property.floorImgrmv');
