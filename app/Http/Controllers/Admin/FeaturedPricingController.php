...
class FeaturedPricingController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.featured-properties.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view("admin.featured-properties.edit", $data);
    }
    ...
    public function requestedForFeatured(Request $request)
    {
        ...
        return view('admin.featured-properties.featured-request', $data);
    }
