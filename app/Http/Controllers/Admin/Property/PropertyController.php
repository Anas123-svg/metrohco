...
class PropertyController extends Controller
{
  ...
  public function settings()
  {
    ...
    return view('admin.property.settings', compact('content'));
  }
  public function propertSettings()
  {
    $content = Basic::select('property_approval_status')->first();
    return view('admin.property.property-settings', compact('content'));
  }
  ...
  public function create(Request $request)
  {
    ...
    return view('admin.property.create', $information);
  }
  ...
  public function edit($id)
  {
    ...
    return view('admin.property.edit', $information);
  }
  ...
  public function featuredPayment(Request $request)
  {
    ...
    if ($request->hasFile('mobile_image')) {
      ...
      if (!empty($property->mobile_image)) {
        @unlink(public_path('assets/img/property/mobile-image/' . $property->mobile_image));
      }

      $image = $request->file('mobile_image');
      $imageName = time() . '.' . $image->getClientOriginalExtension();
      $directory = public_path('assets/img/property/mobile-image/');
      ...
      $property->mobile_image = $imageName;
    }
  ...
  public function updateMobileImage(Request $request)
  {
    $request->validate([
    ...
    $property = Property::findOrFail($request->carId);
    ...
    Session::flash('success', __('Mobile image updated successfully!'));
    return 'success';
  }
