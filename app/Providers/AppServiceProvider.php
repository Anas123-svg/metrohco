  ...
  public function boot()
  {
    ...
    if (!app()->runningInConsole()) {
      ...
      View::composer('admin.*', function ($view) {
        ...
        $websiteSettings = DB::table('basic_settings')->select('admin_theme_version', 'base_currency_symbol', 'base_currency_symbol_position', 'base_currency_symbol_position', 'property_country_status', 'property_state_status', 'base_currency_text_position', 'base_currency_text', 'base_currency_rate', 'theme_version', 'timezone', 'has_mobile_app')->first();
      ...
      View::composer('vendors.*', function ($view) {
        ...
        $websiteSettings = DB::table('basic_settings')->select('admin_theme_version', 'base_currency_symbol', 'base_currency_symbol_position', 'base_currency_text', 'property_country_status', 'property_state_status', 'base_currency_text_position', 'base_currency_rate', 'theme_version', 'timezone', 'has_mobile_app')->first();
